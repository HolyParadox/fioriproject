		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#travelexpenses-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"travelexpenses-display": {
								"semanticObject": "travelexpenses",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=travelexpenses",
									"url": sap.ui.require.toUrl("travelexpenses")
								}
							}
						}
					}
